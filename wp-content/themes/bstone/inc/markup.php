					...
					$banner_content .= '<section id="bp-banner-container" class="'.$classes_container.'">';
						...
						$banner_content .= '<div class="bp-banner-inner">';
							 ...
							 */
								...
								// Apply filters
								$bstone_posts_banner_classes = apply_filters( 'bstone_posts_banner_classes', 'owl-carousel bp-slider' );
								$banner_posts_banner_data_attr = apply_filters( 'banner_posts_banner_data_attr', '' );

								$banner_content .= '<div class="'.$bstone_posts_banner_classes.'" '.$banner_posts_banner_data_attr.'>';

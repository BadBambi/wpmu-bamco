...
if ( ! class_exists( 'Bstone_Dynamic_CSS' ) ) {
	...
	class Bstone_Dynamic_CSS {
		...
		public static function return_output() {
			...
			$parse_css .= bstone_get_responsive_spacings (
				'body #content > .st-container, body.page-builder #content > .st-container',
				'pcnt', 'padding',
				'padding', '',
				'px',
				array('top', 'bottom', 'right', 'left'),
			...
			$parse_css .= bstone_get_responsive_spacings (
				'body:not(.fluid-container) #content > .st-container, body.page-builder #content > .st-container',
				'pcnt', 'margin',
				'margin', '',
				'px',
				array('top', 'bottom'),
			...
			if( 'no-sidebar' != $bst_site_sidebar ) {
				$parse_css .= bstone_get_responsive_spacings (
					'body:not(.fluid-container) #content #primary',
					'carea', 'padding',
					'padding', '',
					'px',
					array('top', 'bottom', 'right', 'left'),
			...
			$site_width = array(
				...
				'.page-builder #content .st-container, .fluid-container #content .st-container' => array(
					'max-width' => '100%',
				),
			);
			$nav_ul_width = array(

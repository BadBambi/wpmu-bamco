...
if ( ! class_exists( 'Bstone_Meta_Boxes' ) ) {
    ...
    class Bstone_Meta_Boxes {
        ...
        function markup_meta_box( $post ) {
			 ...
			 */
			$bstone_site_layouts_meta = apply_filters( 'bstone_site_layouts', array(
				'default' => __( 'Customizer Settings', 'bstone' ),
				'boxed-container' => __( 'Boxed', 'bstone' ),
				'separate-container' => __( 'Separate', 'bstone' ),
				'plain-container' => __( 'Contained', 'bstone' ),
				'page-builder' => __( 'Full Width', 'bstone' ),
				'fluid-container' => __( 'Fluid - No Padding & Margin', 'bstone' )
			));
			?>
			<div class="site-content-layout-meta-wrap">
				...
				<?php
				foreach( $bstone_site_layouts_meta as $siteLayoutKey => $siteLayoutName ) {
					echo '<option value="'.$siteLayoutKey.'"'; selected( $site_content_layout, $siteLayoutKey ); echo'>'.$siteLayoutName.'</option>';
				}
				?>
				</select>
			</div>
